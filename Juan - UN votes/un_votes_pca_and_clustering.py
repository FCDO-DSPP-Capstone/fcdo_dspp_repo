...
Optimal numer of clusters and PCA calulated with elbow methods in older code. 

Export is a long dataframe with country, country code, pca1, pca2, year, and cluster. 
"""
...
####################################
## 3. export pca_results      ##
####################################

results.to_csv('Juan - UN votes/pca_results.csv', index=False)